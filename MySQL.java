...
public class University {
    ...
    private void initTables(Connection db_connection) throws SQLException {
        ...
        statement_prepared.setString(1, "Josh");
        statement_prepared.setString(2, "6");
        statement_prepared.setString(3, "1");
        statement_prepared.addBatch();
        statement_prepared.setString(1, "Garret");
        statement_prepared.setString(2, "6");
        statement_prepared.setString(3, "2");
        statement_prepared.addBatch();
        statement_prepared.setString(1, "Bryce");
        ...
        statement_prepared.setString(2, "1");
        statement_prepared.setString(3, "W");
        statement_prepared.addBatch();
        ...
        statement_prepared.setString(5, "10:30:00");
        statement_prepared.addBatch();
    	...
    	statement_prepared = db_connection.prepareStatement(sql);
        statement_prepared.setString(1, "Brad Miller");
        statement_prepared.setString(2, "1");
        statement_prepared.setString(3, "2020");
        statement_prepared.setString(4, "1");
        statement_prepared.addBatch();
        statement_prepared.setString(1, "Jonah");
        statement_prepared.setString(2, "2");
        statement_prepared.setString(3, "1735");
    	...
    	statement_prepared = db_connection.prepareStatement(sql);
        statement_prepared.setString(1, "Brandt");
        statement_prepared.setString(2, "1");
        statement_prepared.setString(3, "Gaslighting");
        statement_prepared.addBatch();
        statement_prepared.setString(1, "Union");
        statement_prepared.setString(2, "2");
        statement_prepared.setString(3, "Gluttony");
        statement_prepared.addBatch();
		...
		for (int i=0; i<courses.size(); i++) {
			...
			if (current.get(0).length() == 1 | current.get(0).length() == 2 && current.get(0) != "CS" && current.get(0) != "DS" && current.get(0) != "GS" && current.get(0) != "IS" && current.get(0) != "PE" && current.get(0) != "SW") {
				...
				statement_prepared.setString(1, milk);
